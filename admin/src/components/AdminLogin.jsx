...
const handleSubmit=async(e)=>{
  ...
  return (
    <div className=' min-h-screen flex items-center justify-center  bg-linear-to-r from-green-700 via-green-600 to-green-500
 ...
 <div
  ...
  <form onSubmit={handleSubmit} className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 
        ...
        duration-300 hover:csale-[1.02]">
          <h2 className="text-3xl font-bold mb-6 text-center text-white">تسجيل دخول المشرف</h2>
<input
          type="email"
